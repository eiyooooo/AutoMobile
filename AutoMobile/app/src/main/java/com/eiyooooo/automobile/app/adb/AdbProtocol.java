...
public class AdbProtocol {
    ...
    // adapt to the maximum data size of some USB devices
    // old version of adb server hard-coded maxdata=4096, if the device is too old, you can try to modify it to 4096
